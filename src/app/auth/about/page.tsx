...
export default function AuthAboutPage() {
  const features = [
    {
      icon: Clock,
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10 max-w-3xl">
        ...
        {/* Features */}
        <div className="grid md:grid-cols-2 gap-4 mb-12 animate-fade-in-up">
        ...
        <div className="text-center text-slate-500 text-sm pb-8">
          <p>Built with ❤️ using Next.js, Supabase, Tailwind CSS and Music</p>
